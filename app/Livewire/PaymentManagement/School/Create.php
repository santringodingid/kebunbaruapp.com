...
namespace App\Livewire\PaymentManagement\School;
...
class Create extends Component
{
    ...
    public function store(): void
    {
        ...
        $fareOfSchool = FareOfSchool::query()->where('account_id', $this->accountId)->first();
        if ($fareOfSchool) {
            $fareOfSchool->nominal = $nominal;
            $fareOfSchool->save();
        }else{
            FareOfSchool::query()->create([
    ...
    {
        return view('livewire.payment-management.school.create');
    }
}
