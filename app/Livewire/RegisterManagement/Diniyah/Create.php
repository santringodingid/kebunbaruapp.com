...
class Create extends Component
{
    ...
    public function check()
    {
        ...
        if (!$registration) {
            ...
            $this->isNewOld = $registration->is_new_diniyah;
    ...
    public function store()
    {
        ...
        DB::transaction(function (){
            ...
            Registration::query()->where('id', $this->studentId)->update([
                'grade_of_diniyah' => $this->grade,
                'institution_diniyah_id' => $this->institution,
    ...
    {
        return view('livewire.register-management.diniyah.create');
    }
