...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="{{ route('home') }}">
		<img alt="Logo" src="{{ image('default.png') }}" class="h-25px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('default-small.png') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
