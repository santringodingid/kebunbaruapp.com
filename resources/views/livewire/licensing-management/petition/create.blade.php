<div class="modal fade" tabindex="-1" id="modal-add-petition" data-bs-backdrop="static" data-bs-keyboard="false" wire:ignore.self >
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Tambah Permohonan</h3>
            ...
            <form wire:submit.prevent="submit" autocomplete="off" onkeydown="return event.key != 'Enter';">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="reg" wire:model="reg">
                    <div class="row justify-content-between">
                        ...
                        @if(!$mode)
                            <div class="col-12 col-sm-6">
                                <div class="mb-5 row">
                                    <label for="last-education" class="col-sm-4 col-form-label">Alasan</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="mb-5 row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea type="text" wire:model="note" class="form-control " id="note"></textarea>
                                    </div>
                                </div>
                                <div class="mb-5 row">
                                    <label for="domicile-status" class="col-sm-4 col-form-label">Tanda Tangan</label>
                                    <div class="col-sm-8">
                                        <div class="d-flex gap-8 mt-3">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" wire:model="health" value="0" id="p2k" name="health"/>
                                                <label class="form-check-label" for="p2k">
                                                    Bag. Keamanan
                                                </label>
                                            </div>
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" wire:model="health" value="1" id="lp2k" name="health"/>
