                        ...
                        @forelse($formals as $formal)
                            <tr wire:key="{{ $formal->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <button title="Detail data" class="btn btn-icon btn-active-light-primary w-30px h-30px" onclick="addRegistration('{{ $formal->student->id }}')">
