    ...
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_update_role_form" autocomplete="off" class="form" action="#" wire:submit="submit">
                    <!--begin::Scroll-->
                    ...
                    <div class="text-center pt-15">
                        <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal" aria-label="Close" wire:loading.attr="disabled">Discard</button>
