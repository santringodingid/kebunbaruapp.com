    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit="submit" enctype="multipart/form-data" autocomplete="off">
                    <input type="hidden" wire:model="user_id" name="user_id" value="{{ $user_id }}"/>
                    <div class="row">
                    <div class="col-xxl-5 px-5 px-lg-10">
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder {{ $avatar || $saved_avatar ? '' : 'image-input-empty' }}" data-kt-image-input="true">
                                ...
                                @if($avatar)
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $avatar->temporaryUrl() }});"></div>
                                @else
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('storage/'.$saved_avatar) }});"></div>
                                @endif
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select wire:model="institution" name="institution" class="form-control form-control-solid mb-3 mb-lg-0">
                    ...
                    <!--begin::Scroll-->
                    <div class="col-xxl-7 scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="mb-7">
                            <!--begin::Label-->
