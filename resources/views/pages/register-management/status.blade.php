<x-default-layout>
    ...
    @section('button')
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-add-status">
    ...
    <div class="row gx-5 gx-xl-10">
        <livewire:register-management.status.index  lazy/>
    </div>
    <!--end::Row-->

    <livewire:register-management.status.create/>
